...
// async
export const taroAsyncRequest = taroRequest.requestAsync.bind(taroRequest)
export const taroGetAsync = taroRequest.getAsync.bind(taroRequest)
export const taroPostAsync = taroRequest.postAsync.bind(taroRequest)
export const taroPutAsync = taroRequest.putAsync.bind(taroRequest)
export const taroDeleteAsync = taroRequest.deleteAsync.bind(taroRequest)
export const taroPatchAsync = taroRequest.patchAsync.bind(taroRequest)
