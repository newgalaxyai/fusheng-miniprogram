        ...
        {annualDetail?.shareholderList.map((shareholder, idx) => (
          <View className="shareholder-card" key={idx}>
            <View className="card-header">
              <View className={'avatar ' + (shareholder.investorName.length >= 4 ? 'avatar-4' : 'avatar-1')}>
                {shareholder.investorName.length >= 4 ? shareholder.investorName.slice(0, 4) : shareholder.investorName[0]}
              </View>
              <View className="info">
