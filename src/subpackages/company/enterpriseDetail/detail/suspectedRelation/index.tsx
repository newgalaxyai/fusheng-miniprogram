          ...
          return (
            <View className="card-item">
              <View className="item-header">
                {suspected.logo ? <Image className="logo" src={suspected.logo} /> : <View className={'logo avatar ' + (suspected.alias.length >= 4 ? 'avatar-4' : 'avatar-1')}>{suspected.alias[0]}</View>}
                <View className="name">
                  ...
                  <View className="name-bottom">
                    <Text className="text-ellipsis">{suspected.legalPerson[0].legalRepName || '- -'}</Text>
